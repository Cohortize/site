  ...
  const emailInput = () => {
    return(
      ...
      <div className="grid gap-6">
        ...
        <Button className="w-full bg-[rgb(44,44,44)] hover:bg-[rgb(48,48,48)] cursor-pointer" onClick={otpToggle}>
          Send OTP
        </Button>
      </div>
    </form>);
  ...
  const otpInput = () => {
    ...
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="grid gap-6 justify-center">
        ...
        <Button className="w-full bg-[rgb(44,44,44)] hover:bg-[rgb(48,48,48)] cursor-pointer">
          Submit OTP
        </Button>
      </div>
    </form>
