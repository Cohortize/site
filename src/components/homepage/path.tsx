...
const Path = () => {
   ...
   <div className="path-section min-h-screen w-full bg-black flex items-center px-4 sm:px-8 lg:px-16 xl:px-20 py-8 sm:py-16">
      ...
      <Xwrapper>
        <Xarrow start={'ship'} end={'collaborate'} color="rgba(255,255,255,0.3)" strokeWidth={2} showHead={false}/>
        <Xarrow start={'find'} end={'collaborate'} color="rgba(255, 255,255, 0.3)" strokeWidth={2} showHead={false}/>
        <Xarrow start={'collaborate'} end={'magic'} color="rgba(255,255,255,0.3)" strokeWidth={1.5} showHead={false}/>
      </Xwrapper>
    </div>
    );
};
